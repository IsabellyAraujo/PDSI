<%@ Page Title="Fornecedor" Language="C#" MasterPageFile="~/MasterPage.Master" AutoEventWireup="true" CodeBehind="IncluirFornecedor.aspx.cs" Inherits="PSI.Fornecedor.IncluirFornecedor" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <table>
        ...
        <tr>
            ...
            <td>
                <asp:LinkButton ID="LinkButton2" runat="server" PostBackUrl="~/Forncedor/CadastroForncedor.aspx">Cancelar</asp:LinkButton> 
            </td>
        </tr>
    </table>
</asp:Content>